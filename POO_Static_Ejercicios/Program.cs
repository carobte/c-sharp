...
Console.WriteLine($"La suma de {num1} y {num2} es {suma2}");

var resta2 = CalculadoraAritmetica.Restar(num1, num2);
Console.WriteLine($"La resta de {num1} y {num2} es {resta2}");

var multiplicacion2 = CalculadoraAritmetica.Multiplicar(num1, num2);
Console.WriteLine($"La multiplicacion de {num1} por {num2} es {multiplicacion2}");

var division2 = CalculadoraAritmetica.Dividir(num1, num2);
Console.WriteLine($"La division de {num1} entre {num2} es {division2}");
Console.WriteLine("============================================");
